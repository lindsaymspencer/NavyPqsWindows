...
namespace NavyPqs.Domain.Models.Cwo
{
    public class TwoBravo : IPqsModel
    {
        ...
        public string Pqs => "CWO";

        public string Version => "2B";

        public string LongName => "NAVEDTRA 43357-2B";

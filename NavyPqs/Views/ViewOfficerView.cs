...
namespace NavyPqs.Views
{
    public partial class frmViewOfficer : Form
    {
        ...
        public frmViewOfficer(Officer officer)
        {
            ...
            SetTwoAlpha(officer.TwoAlpha);
            SetTwoBravo(officer.TwoBravo);

            cmbBxSections2A.SelectedIndex = 0;
            cmbBxSections2B.SelectedIndex = 0;
        }

        private void SetTwoBravo(TwoBravo twoBravo)
        {
            foreach (var section in twoBravo.Sections)
            {
        ...
        private void SetTwoAlpha(TwoAlpha twoAlpha)
        {
            foreach (var section in twoAlpha.Sections)
            {
